...
class ListInformations():
    ...
    def list_informations(self):
        ...
        print("User: " + int(datas_api['id']))
        print("User: " + datas_api['avatar_url'])
        print("User: " + datas_api['name'])
        print("User: " + datas_api['company'])
        print("User: " + datas_api['location'])
        print("User: " + datas_api['bio'])
        print("User: " + datas_api['public_repos'])
        print("User: " + datas_api['followers'])
        print("User: " + datas_api['following'])
        print("User: " + datas_api['created_at'])
        print("User: " + datas_api['updated_at'])
